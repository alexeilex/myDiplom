...
## Результаты кода в картинках и схемах
![[Figure_1.png]]
![[image-2026.04.10 Решение первой поставленной задачи, результаты-1.png]]




## Дополнительно
Тут ничего особенного по аппроксимации границ, беру P_out просто справа, P_in слева. 